...
(function (Chip8Assembler) {
    function assemble(contents, parse) {
        var lines = parse(contents);
        return transformParsedProgram(lines);
    }
    Chip8Assembler.assemble = assemble;
    var AssemblerException = (function () {
        function AssemblerException(message) {
            this.message = message;
        }
        AssemblerException.prototype.toString = function () {
            return this.message;
        };
        return AssemblerException;
    })();
    function transformParsedProgram(lines) {
...
module.exports = Chip8Assembler;
//# sourceMappingURL=Chip8Assembler.js.map